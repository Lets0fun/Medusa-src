...
struct HealthBar : ColorToggle {
    ...
    Color4 TopGradient{ 0.545f, 1.000f, 0.545f, 1.000f };
    Color4 BottomGradient{ 1.000f, 0.455f, 0.455f, 1.000f };
    int type = Type::Gradient;
    bool outline = true;
    bool background = true;
};

struct AmmoBar: ColorToggle {
    enum Type {
        Gradient = 0,
        Solid,
    };
    Color4 LeftGradient{ 1.000f, 0.455f, 0.455f, 1.000f };
    Color4 RightGradient{ 0.545f, 0.840f, 1.000f, 1.000f };
    int type = Type::Gradient;
    bool outline = true;
    bool background = true;
};
...
struct Player : Shared {
    Player() : Shared{}
    {
        ...
        ammoBar.color = { 0.400f, 0.789f, 1.000f, 1.000f };
    }
    ColorToggle weapon;
...
#define WRITEP(name, valueName) to_json(j[name], p.valueName, dummyp.valueName)
