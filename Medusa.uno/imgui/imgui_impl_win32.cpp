...
void ImGui_ImplWin32_EnableDpiAwareness()
{
    ...
    {
        static HINSTANCE user32_dll = ::LoadLibraryA(skCrypt("user32.dll")); // Reference counted per-process
    ...
    {
        static HINSTANCE shcore_dll = ::LoadLibraryA(skCrypt("shcore.dll")); // Reference counted per-process
...
float ImGui_ImplWin32_GetDpiScaleForMonitor(void* monitor)
{
    ...
    {
        static HINSTANCE shcore_dll = ::LoadLibraryA(skCrypt("shcore.dll")); // Reference counted per-process
        if (PFN_GetDpiForMonitor GetDpiForMonitorFn = (PFN_GetDpiForMonitor)::GetProcAddress(shcore_dll, skCrypt("GetDpiForMonitor")))
